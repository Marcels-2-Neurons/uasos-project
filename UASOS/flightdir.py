...
class flightdir:
    def __init__(self, x=0, y=0, width=0, height=0):
        ...
        self.border = visual.Rect(SRCwin, pos=(x, y),
                                  size=(width, height),
                                  fillColor=Colors.lgray,
                                  opacity=1.0,
                                  colorSpace='rgb255')
        self.face = visual.Rect(SRCwin, pos=(x, y),
                                size=(width, height),
                                fillColor=Colors.gray,
                                opacity=1.0,
                                colorSpace='rgb255')
        self.screen = visual.Rect(SRCwin, pos=(x, y),
                                  size=(width, height),
                                  fillColor=Colors.dgray,
                                  opacity=1.0,
                                  colorSpace='rgb255')
        self.led = visual.Circle(SRCwin, pos=(x, y),
                                 size=(width, height),
        ...
        self.text_src = visual.TextStim(win=SRCwin, name='text',
                                        text=src_str,
        ...
        self.text_item = visual.TextStim(win=SRCwin, name='text',
                                         text=item_str,
                                         font='Arial Unicode MS',
        ...
        self.hold_text = visual.TextStim(win=SRCwin, name='text',
                                         text=hold_str,
                                         font='Arial Unicode MS',
